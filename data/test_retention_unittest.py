...
class TestCalculateNDayRetention(unittest.TestCase):
    ...
    def test_empty_dataframe(self):
        ...
        self.assertEqual(calculate_n_day_retention(df), 0.0)
    ...
    def test_single_user_no_retention(self):
        ...
        self.assertEqual(calculate_n_day_retention(df, n_days=7), 0.0)
    ...
    def test_single_user_with_retention(self):
        ...
        df = create_test_data(users_data)
        self.assertEqual(calculate_n_day_retention(df, n_days=7), 1.0)
    ...
    def test_multiple_users_mixed_retention(self):
        ...
        df = create_test_data(users_data)
        self.assertEqual(calculate_n_day_retention(df, n_days=7), 0.5)
    ...
    def test_n_day_retention_3_day(self):
        ...
        df = create_test_data(users_data)
        self.assertAlmostEqual(calculate_n_day_retention(df, n_days=3), 0.666666666, places=6)
    ...
    def test_complex_scenario(self):
        ...
        df = create_test_data(users_data)
        self.assertAlmostEqual(calculate_n_day_retention(df, n_days=7), 0.333333333, places=6)
